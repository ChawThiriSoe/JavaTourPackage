...
public class Booking extends JFrame {
	...
	public Booking() {
		...
		lblBid.setFont(new Font("Times New Roman", Font.BOLD, 18));
		lblBid.setBounds(365, 112, 176, 19);
		contentPane.add(lblBid);
		
		JLabel lblPgid = new JLabel("");
		lblPgid.setForeground(new Color(255, 255, 255));
		lblPgid.setFont(new Font("Times New Roman", Font.BOLD, 18));
		lblPgid.setBounds(365, 155, 176, 19);
