...
public class Package extends JFrame {
	 ...
	 */
	public Package() {
		setTitle("Package Information Form");
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 773, 580);
		...
		rdbtnPremiumPackage.setBackground(new Color(216, 191, 216));
		...
		rdbtnStandardPackage.setBackground(new Color(216, 191, 216));
		...
		txtPrice.setBackground(new Color(216, 191, 216));
		txtPrice.setColumns(10);
		txtPrice.setBounds(232, 165, 163, 20);
		contentPane.add(txtPrice);
		
		lblDescirption = new JLabel("Descirption");
		lblDescirption.setForeground(new Color(255, 255, 255));
		...
		lblPromotion.setForeground(new Color(255, 255, 255));
		...
		txtDes.setBackground(new Color(216, 191, 216));
		...
		txtPro.setBackground(new Color(216, 191, 216));
		...
		btnBack.setBounds(42, 502, 89, 23);
		...
		btnInfo.setBounds(506, 502, 203, 23);
		contentPane.add(btnInfo);
		
		JLabel label = new JLabel("");
		label.setIcon(new ImageIcon("D:\\@Sue\\year2\\first semeter\\assignment\\Java\\1.jpg"));
		label.setBounds(0, 0, 757, 547);
